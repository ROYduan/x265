...
(HEVC) standard, also known as H.265. The s265 HEVC encoder project was
...
The primary objective of s265 is to become the best H.265/HEVC encoder
available anywhere, offering the highest compression efficiency and the
highest performance on a wide variety of hardware platforms. The s265
...
commercial companies to utilize and distribute s265 in their solutions
without being subject to the restrictions of the GPL license.

s265 is developed by `MulticoreWare <http://www.multicorewareinc.com>`_,
...
developers.  s265 leverages many of the outstanding video encoding
features and optimizations from the x264 AVC encoder project.

The s265 software is available for free under the GNU GPL 2 license,
from https://bitbucket.org/multicoreware/s265_git.  For commercial companies
that wish to distribute s265 without being subject to the open source
requirements of the GPL 2 license, commercial licenses are available
with competitive terms.  Contact license @ s265.com to inquire about
commercial license terms.  

While s265 is primarily designed as a video encoder software library, a
command-line executable is provided to facilitate testing and
development.  We expect s265 to be utilized in many leading video
hardware and software products and services in the coming months.

LEGAL NOTICES
=============

The s265 software is owned and copyrighted by MulticoreWare, Inc.
MulticoreWare is committed to offering the s265 software under the GNU
GPL v2 license.  Companies who do not wish to integrate the s265
Software in their products under the terms of the GPL license can
contact MulticoreWare (license @ s265.com) to obtain a commercial
license agreement.  Companies who use s265 under the GPL may also wish
...
The GNU GPL v2 license or the s265 commercial license agreement govern
your rights to access the copyrighted s265 software source code, but do
not cover any patents that may be applicable to the function of binary
executable software created from the s265 source code.  You are
...
software applications created from the s265 source code.  A good place
...
s265 is a registered trademark of MulticoreWare, Inc.  The s265 logo is
