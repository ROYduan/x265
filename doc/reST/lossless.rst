...
s265 can encode HEVC bitstreams that are entirely lossless (the
...
Instead, s265 reports only a compression factor at the end of the
encode.
...
ratio (and the slower the encode). Here are some examples::
	...
	./s265 ../test-720p.y4m o.bin --preset ultrafast --lossless
	... <snip> ...
	encoded 721 frames in 238.38s (3.02 fps), 57457.94 kb/s

	./s265 ../test-720p.y4m o.bin --preset faster --lossless
	... <snip> ...
	s265 [info]: lossless compression ratio 3.11::1
	encoded 721 frames in 258.46s (2.79 fps), 56787.65 kb/s

	./s265 ../test-720p.y4m o.bin --preset slow --lossless
	... <snip> ...
	s265 [info]: lossless compression ratio 3.36::1
	encoded 721 frames in 576.73s (1.25 fps), 52668.25 kb/s

	./s265 ../test-720p.y4m o.bin --preset veryslow --lossless
	s265 [info]: lossless compression ratio 3.76::1
	encoded 721 frames in 6298.22s (0.11 fps), 47008.65 kb/s
 
.. Note::
	In HEVC, only QP=4 is truly lossless quantization, and thus when
	encoding losslesly s265 uses QP=4 internally in its RDO decisions.
...
which are not lossless::
	...
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 40000 --ssim
	encoded 721 frames in 326.62s (2.21 fps), 39750.56 kb/s, SSIM Mean Y: 0.9990703 (30.317 dB)
	
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 50000 --ssim
	encoded 721 frames in 349.27s (2.06 fps), 44326.84 kb/s, SSIM Mean Y: 0.9994134 (32.316 dB)
	
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 60000 --ssim
...
near-lossless bitstreams::
	...
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 40000 --ssim --cu-lossless
	encoded 721 frames in 500.51s (1.44 fps), 40017.10 kb/s, SSIM Mean Y: 0.9997790 (36.557 dB)
	
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 50000 --ssim --cu-lossless
	encoded 721 frames in 524.60s (1.37 fps), 46083.37 kb/s, SSIM Mean Y: 0.9999432 (42.456 dB)
	
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 60000 --ssim --cu-lossless
...
this makes the encodes run even slower::
	...
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 40000 --ssim --cu-lossless --psy-rd 1.0
	encoded 721 frames in 581.83s (1.24 fps), 40112.15 kb/s, SSIM Mean Y: 0.9998632 (38.638 dB)
	
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 50000 --ssim --cu-lossless --psy-rd 1.0
	encoded 721 frames in 587.54s (1.23 fps), 46284.55 kb/s, SSIM Mean Y: 0.9999663 (44.721 dB)
	
	./s265 ../test-720p.y4m o.bin --preset medium --bitrate 60000 --ssim --cu-lossless --psy-rd 1.0
...
blocks that would benefit from lossless coding::
	...
	./s265 ../test-720p.y4m o.bin --preset veryslow --bitrate 40000 --ssim --cu-lossless
	encoded 721 frames in 12969.25s (0.06 fps), 37331.96 kb/s, SSIM Mean Y: 0.9998108 (37.231 dB)
	
	./s265 ../test-720p.y4m o.bin --preset veryslow --bitrate 50000 --ssim --cu-lossless
	encoded 721 frames in 46217.84s (0.05 fps), 42976.28 kb/s, SSIM Mean Y: 0.9999482 (42.856 dB)
	
	./s265 ../test-720p.y4m o.bin --preset veryslow --bitrate 60000 --ssim --cu-lossless
...
possible::
	...
	./s265 ../test-720p.y4m o.bin --preset veryslow --bitrate 40000 --ssim --cu-lossless --psy-rd 1.0
	encoded 721 frames in 11675.81s (0.06 fps), 37819.45 kb/s, SSIM Mean Y: 0.9999181 (40.867 dB)
	    
	./s265 ../test-720p.y4m o.bin --preset veryslow --bitrate 50000 --ssim --cu-lossless --psy-rd 1.0
	encoded 721 frames in 12414.56s (0.06 fps), 42815.75 kb/s, SSIM Mean Y: 0.9999758 (46.168 dB)
	
	./s265 ../test-720p.y4m o.bin --preset veryslow --bitrate 60000 --ssim --cu-lossless --psy-rd 1.0
