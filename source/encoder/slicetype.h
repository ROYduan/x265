...
protected:
    ...
    int temporalFilter( Frame **frames, Lowres **lowresFrames, int32_t b, const int32_t s_range, int32_t qp);
    void applyMotion( MV *lowres_mv, Frame * frame, Frame *curFrame, pixel *dst[3], int *inter_cost, int32_t *intra_cost );
    void bilateralFilter( pixel *corrected_pics[10][3], Frame *curFrame, double overall_strength,  int32_t num_refs, const int32_t s_range, int32_t m_qp, int32_t offset_index[10] );
