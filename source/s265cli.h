...
static const struct option long_options[] =
{
    ...
    { "cutree-type",    required_argument, NULL, 0 },
    { "dpb-method",     required_argument, NULL, 0 },
    { "pyramid-qp-method",     required_argument, NULL, 0 },
    { "cost-calculate-pskip",  required_argument, NULL, 0 },
    { "t-filter-enable",  required_argument, NULL, 0 },
    { "t-filter-gopsize",     required_argument, NULL, 0 },
    { "t-filter-qp",          required_argument, NULL, 0 },
    { "t-filter-thres0",      required_argument, NULL, 0 },
    { "t-filter-thres1",      required_argument, NULL, 0 },
    { "t-filter-strength0",   required_argument, NULL, 0 },
    { "t-filter-strength1",   required_argument, NULL, 0 },
    { "t-filter-strength2",   required_argument, NULL, 0 },
    { "t-filter-method",      required_argument, NULL, 0 },
    { "t-filter-mvmatch",     required_argument, NULL, 0 },
    { "t-filter-range",       required_argument, NULL, 0 },
