...
if(HIGH_BIT_DEPTH)
    if(MAIN12)
        list(APPEND ASM_FLAGS -DHIGH_BIT_DEPTH=1 -DBIT_DEPTH=12 -DS265_NS=${S265_NS})
    else()
        list(APPEND ASM_FLAGS -DHIGH_BIT_DEPTH=1 -DBIT_DEPTH=10 -DS265_NS=${S265_NS})
    endif()
else()
    list(APPEND ASM_FLAGS -DHIGH_BIT_DEPTH=0 -DBIT_DEPTH=8 -DS265_NS=${S265_NS})
endif()
